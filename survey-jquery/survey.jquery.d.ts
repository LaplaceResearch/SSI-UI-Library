/*Type definitions for Survey JavaScript library v1.0.17
...
export interface ISurvey extends ITextProcessor {
        ...
        downloadFile(name: string, value: File, downloadingCallback: (status: string, data: any) => any): boolean;
...
export declare class SurveyModel extends Base implements ISurvey, ISurveyData, ISurveyImpl, ISurveyTriggerOwner, ILocalizableOwner {
        ...
        /**
            ...
            */
        downloadFile(questionName: string, value: any, downloadingCallback: (status: string, data: any) => any): boolean;
